...
void ain() => runApp(const DropdownButtonApp2());

class DropdownButtonApp2 extends StatelessWidget {
  const DropdownButtonApp2({super.key});
...
void win() => runApp(const DropdownButtonApp3());

class DropdownButtonApp3 extends StatelessWidget {
  const DropdownButtonApp3({super.key});
